...
| [Injury Valuation Cleanup](injury-valuation-cleanup.md) | 3 | phases 1-2 done | injury-risk-discount (done) |
...
| [Roster Optimizer](roster-optimizer.md) | 3 | phases 1-2 done | valuations (done) |
