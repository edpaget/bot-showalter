...
| [Draft Pick Keeper Support](draft-pick-keeper-support.md) | 3 | phase 1 done | draft-pick-trade-evaluator phase 1, keeper-surplus-value (done) |
...
| [Positional Upgrade Calculator](positional-upgrade-calculator.md) | 4 | phases 1-2 done | draft board (done) |
...
| [Test Coverage](test-coverage.md) | 5 | phases 1-2 done | none |
