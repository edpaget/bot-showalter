...
| [Web UI Foundation](web-ui-foundation.md) | 6 | phase 1 done | draft-session-persistence (phase 2 needs phases 1-2) |
...
| [Variance Correction](variance-correction.md) | 3 | phase 1 done | none |
