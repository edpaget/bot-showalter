...
class MarcelRateComputer:
    """Marcel rate computer using DataSource[T] protocol.

    Implements the new-style RateComputer protocol. Legacy callers
    (MTLRateComputer, MLERateComputer, etc.) should use
    compute_batting_rates_legacy / compute_pitching_rates_legacy
