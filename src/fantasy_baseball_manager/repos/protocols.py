...
@runtime_checkable
class PlayerAliasRepo(Protocol):
    def upsert(self, alias: PlayerAlias) -> int: ...
    def upsert_batch(self, aliases: builtins.list[PlayerAlias]) -> int: ...
    def find_by_name(self, alias_name: str) -> builtins.list[PlayerAlias]: ...
    def find_by_player(self, player_id: int) -> builtins.list[PlayerAlias]: ...
...
class DraftSessionRepo(Protocol):
    ...
    def load_trades(self, session_id: int) -> builtins.list[DraftSessionTrade]: ...
...
@runtime_checkable
class LeagueKeeperRepo(Protocol):
