...
export type PickResultFieldsFragment = { __typename?: 'PickResultType', pick: { __typename?: 'DraftPickType', pickNumber: number, team: number, playerId: number, playerName: string, position: Position, price: number | null }, state: { __typename?: 'DraftStateType', sessionId: number, currentPick: number, format: string, teams: number, userTeam: number, budgetRemaining: number | null, picks: Array<{ __typename?: 'DraftPickType', pickNumber: number, team: number, playerId: number, playerName: string, position: Position, price: number | null }> }, recommendations: Array<{ __typename?: 'RecommendationType', playerId: number, playerName: string, position: Position, value: number, score: number, reason: string }>, roster: Array<{ __typename?: 'DraftPickType', pickNumber: number, team: number, playerId: number, playerName: string, position: Position, price: number | null }>, needs: Array<{ __typename?: 'RosterSlotType', position: Position, remaining: number }>, arbitrage: { __typename?: 'ArbitrageReportType', currentPick: number, falling: Array<{ __typename?: 'FallingPlayerType', playerId: number, playerName: string, position: string, adp: number, currentPick: number, picksPastAdp: number, value: number, valueRank: number, arbitrageScore: number }>, reaches: Array<{ __typename?: 'ReachPickType', playerId: number, playerName: string, position: string, adp: number, pickNumber: number, picksAheadOfAdp: number, drafterTeam: number }> } | null };
...
export type StartSessionMutation = { __typename?: 'Mutation', startSession: { __typename?: 'DraftStateType', sessionId: number, currentPick: number, format: string, teams: number, userTeam: number, budgetRemaining: number | null, picks: Array<{ __typename?: 'DraftPickType', pickNumber: number, team: number, playerId: number, playerName: string, position: Position, price: number | null }> } };
...
export type ProjectionsQuery = { __typename?: 'Query', projections: Array<{ __typename?: 'ProjectionType', playerName: string, system: string, version: string, sourceType: string, playerType: string, stats: Record<string, unknown> }> };
