...
export type StartSessionMutation = { __typename?: 'Mutation', startSession: { __typename?: 'DraftStateType', sessionId: number, currentPick: number, format: string, teams: number, userTeam: number, budgetRemaining: number | null, keeperCount: number, picks: Array<{ __typename?: 'DraftPickType', pickNumber: number, team: number, playerId: number, playerName: string, position: Position, price: number | null }>, trades: Array<{ __typename?: 'DraftTradeType', teamA: number, teamB: number, teamAGives: Array<number>, teamBGives: Array<number> }> } };
